...
public class UpdatesListAdapter extends ArrayAdapter<Updates> {
	 ...
	 * 
	 * Iterates through each update and changes the format for the words that
	 * have hashtags. This will make them stand out easier for the user, and
	 * look more appealing. Returns a single view for each item in the list.
	 */
	@Override
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		for (int i = 0; i < updateText.length(); i++) {
			...
			if (updateText.charAt(i) == '#') {
				...
				formattedHashtagText.insert(i + paddingSize,
						"<font color=\"#E81A08\">");
				...
				// Add onto the padding size in case there is another hashtag in
				// the sentence.
